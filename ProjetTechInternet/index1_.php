...
<title>Welcome to TechMarket</title>
        ...
        <div class="container-fluid">
            <div class="row">
            	<div class="col-10 col-sm-8 col-md-5 col-lg-4">
                    ...
                    <p class="phone-no"><i class="anm anm-phone-s"></i> (+32) 465 748 067</p>
                </div>
                ...
                <div class="col-2 col-sm-4 col-md-3 col-lg-4 text-right">
                    ...
                    <ul class="customer-links list-inline">
                        <li><a href="./pages/page405.php">Connexion</a></li>
                        <li><a href="./pages/page405.php">Créer un Compte</a></li>
                        <li><a href="./pages/page405.php">laissez un avis</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                	...
                	<nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                        <ul id="siteNav" class="site-nav medium center hidearrow">
                            <li class="lvl1 parent megamenu"><a href="./pages/page405.php">Accueil <i class="anm anm-angle-down-l"></i></a>
                                
                            <li class="lvl1 parent megamenu"><a href="./pages/page405.php">Nos Produits <i class="anm anm-angle-down-l"></i></a>
                            	
                            </li>
                        <li class="lvl1 parent megamenu"><a href="./pages/page405.php">Nous Contactez <i class="anm anm-angle-down-l"></i></a>
                        	
                          	
                        </li>
                        <li class="lvl1 parent megamenu"><a href="./pages/page405.php">A propos de Nous <i class="anm anm-angle-down-l"></i></a>
                        ...
                        <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                            <div class="slideshow__text-content bottom">
                                <div class="wrap-caption center">
                                        <h2 class="h1 mega-title slideshow__title">Achetez notre nouvelle collection</h2>
                                        <span class="mega-subtitle slideshow__subtitle">Gagnant de l'ordinateur portable Choix des lecteurs.Le plus fiable
                                            Marque d'ordinateurs portables par UFC-Que Choisir</span>
                                        <span class="btn">Achetez Maintenant</span>
                                    </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slide">
                	<div class="blur-up lazyload bg-size">
                        ...
                        <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                            <div class="slideshow__text-content bottom">
                                <div class="wrap-caption center">
                                    <h2 class="h1 mega-title slideshow__title">Apple Trade In</h2>
                                    <span class="mega-subtitle slideshow__subtitle">Vos données de santé. Sous votre contrôle Confidentialité C'est l'iPhone.
                                        Échange. Mise à niveau. Sauvegarder. C'est un gagnant-gagnant-gagnant.</span>
                                    <span class="btn">Achetez Maintenant </span>
                                </div>
                            </div>
                        </div>
            	...
            	<div class="footer-top">
                	<div class="row">
                    	<div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                            ...
                            <ul>
                            	<li><a href="#">Sons,Casque,Enceintes</a></li>
                                <li><a href="#">Informatique,Tablette</a></li>
                                <li><a href="#">Smartphone & Objets connectés</a></li>
                                <li><a href="#">TV,Vido,Homecinéma</a></li>
                                <li><a href="#">Caméra,Photo</a></li>
                            </ul>
                        </div>
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact-box">
                            ...
                            <ul class="addressFooter">
                            	<li><i class="icon anm anm-map-marker-al"></i><p>55 Boulevard sainctelle,<br>7000 Mons, Belgique</p></li>
                                <li class="phone"><i class="icon anm anm-phone-s"></i><p>(+32) 465 748 067 </p></li>
                                <li class="email"><i class="icon anm anm-envelope-l"></i><p>Techmarket@hotmail.com</p></li>
                            </ul>
                        </div>
                    </div>
                </div>
